...
В этих списках хранятся очки каждого участника (это вещественные числа с двумя знаками после точки,
например 4.03). Участник одной команды соревнуется с участником другой команды под таким же номером.
...
list_1 = [random.randrange(500, 1000, 1)/100 for i in range(20)]
list_2 = [random.randrange(500, 1000, 1)/100 for i in range(20)]
high_values = [max(list_1[i],list_2[i])for i in range(20)]
print('Первая команда:', list_1)
print('Вторая команда:', list_2)
print('Победители тура:',high_values)