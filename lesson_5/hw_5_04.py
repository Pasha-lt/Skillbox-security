...
# первые десять человек из списка. Потом среди поступивших определяется, кто будет на стипендии.
...
list_number = int(input('Введите место в списке поступающих: '))
grant = int(input('Введите место в списке поступающих: '))
print(foo(list_number, grant))